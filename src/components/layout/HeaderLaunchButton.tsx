...
export default function HeaderLaunchButton() {
  ...
  return (
    <button
      onClick={handleClick}
      className="relative header-btn px-2 sm:px-3 md:px-4 py-1 sm:py-1.5 md:py-2 font-primary text-[9px] sm:text-[10px] md:text-sm font-medium leading-[143%] tracking-[0.01em] text-center text-[#ebedff]"
      style={{
