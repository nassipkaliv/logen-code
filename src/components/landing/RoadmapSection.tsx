...
export default function RoadmapSection() {
  return (
    <section id="roadmap" className="relative pt-16 md:pt-24 overflow-hidden">
      {/* Section labels - constrained to 1310px */}
      <div className="relative max-w-[1310px] mx-auto px-4 mb-[40px] md:mb-[70px]">
        <div className="absolute -top-4 left-0 hidden sm:block">
          <div className="relative px-3 py-2">
            ...
            <span className="font-mono text-[10px] font-medium leading-[160%] uppercase text-[rgba(237,237,248,0.16)]">
              [<span className='text-white'>06</span> / 07]
            </span>
          </div>
        </div>
      ...
      <div className="max-w-[1620px] mx-auto px-4 overflow-x-auto">
